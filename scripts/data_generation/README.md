The Python notebook `Generate_MFM_data.ipynb` can be used to generate the mean-field model datasets with variable amount of noise. This saved datasets in pickle format.  
